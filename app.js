...
app.post('/uploaddp', async function(req, res){
    try
    {
        ...
        myfile.mv('../src/images/photo/'+ fname +'.png', function(err){
            if(err)
...
app.post('/sendemail', async function(req, res){
    try
    {
        var transport = nodemailer.createTransport({
            ...
            port: 445,
            secure: true,
            auth:{user: "pcschaitanyasai@gmail.com", pass: "ecgohzkfxegekuyf"}
        });

        var emaildata = {
            from: "pcschaitanyasai@gmail.com",
            to: "kotagiricharandeep@gmail.com",
